 ...
 *
 * Second rail on the page, dashed rather than solid so the two read as a pair
 * rather than a repeated element: PickYourDoor's rail is the passing-not-allowed
 * line down a sorting decision, this one is the dashed line down a sequence.
 */
export default function JourneyBand({ block }: { block: any }) {
  return (
    <section className="border-y border-[var(--line)] bg-[var(--subtle)]">
      <div className="ks-railed mx-auto max-w-6xl px-4 py-10">
